	...
	<body>
		<div class="container" >
		   <div id="header">
		    ...
		    <h2><font face="微软雅黑", size="5 ",color="#FFFF00">&nbsp&nbsp&nbsp&nbspYeeCharge&nbsp Solar &nbspCharging &nbspStation &nbspPlatform</font></h2>
		    </div>
		</div>
			...
			<div id="main">
				...
				<center> <p>欢&nbsp迎&nbsp来&nbsp到&nbspYeeCharge</p></center>
