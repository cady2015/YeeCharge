		...
		<div class="row" style="background: #3399CC;width:100%;height:100%;padding-top:80px">
			...
			<div class="col-md-8" style=" background-image:url(img/regist_bg.jpg);aliment:center; margin: 30px;border: 7px solid #CCCCCC;">
				<div style="padding-left:120px">
					<h1>新用户注册        USER  REGISTER</h1>
				</div>
				<br/>
				<form action="/RegistServlet" method="post" class="form-horizontal" onsubmit="return checkForm()" style="margin-top: 5px;">
					<input type="hidden" name="method" value="regist"/>
					<div class="form-group">
					   <label for="username" class="col-sm-2 control-label">用户名</label>
					   <div class="col-sm-6">
					   		<input type="text" class="form-control" id="username"  name="username" value="${param.username }" placeholder="请输入用户名" onblur="checkUsrname(this)"/>
						</div> 
							<a id="username_msg"></a>
					</div>
					...
					<div class="form-group">
					   ...
					   <div class="col-sm-6">
					   		<input type="text" class="form-control" id="phonenum" maxlength="11" name="phonenum" value="${param.phonenum }" placeholder="请输入手机号码" onblur="checkPhonenum(this)"/>
					</div>
							<a id="phonenum_msg"></a> 
					</div>
					...
					<div class="form-group">
					   ...
					   <div class="col-sm-6">
					   		<input type="text" class="form-control" id="email"  name="email" placeholder="请输入邮箱" value="${param.email }" onblur="checkEmail(this)"/>
						</div>
					   		<a id="email_msg"></a>
					</div>
